...
if %errorLevel% equ 0 (
    ...
    echo =======================================================
    echo   SOP AUTO-LOGGING - RUNNING AS STANDARD USER
    echo =======================================================
...
if errorlevel 1 (
    echo [INFO] First-time setup: installing dependencies pyautogui and Pillow...
...
:: Launch SOP Auto-Logging
echo Starting SOP Auto-Logging HUD...
echo.
"%PY_CMD%" sop_main.py %*
